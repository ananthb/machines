{ config, ... }:
{
  services.cloudflared = {
    ...
    tunnels."kedi" = {
      ...
      ingress = {
        "6a.kedi.dev" = "http://10.15.16.202:8123";
        "actual.kedi.dev" = "http://10.15.16.202:3100";
        "apps.kedi.dev" = "http://voyager:8082"; # TODO: switch to .local after making it work
        "immich.kedi.dev" = "http://localhost:2283";
        "mealie.kedi.dev" = "http://10.15.16.202:9000";
        "open-webui.kedi.dev" = "http://localhost:8090";
        "radicale.kedi.dev" = "http://10.15.16.202:5232";
        "seafile.kedi.dev" = "http://localhost:4000";
        "vault.kedi.dev" = "http://10.15.16.202:8222";
      };
      credentialsFile =
