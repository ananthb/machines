{ config, ... }:
{
  services.cloudflared = {
    ...
    tunnels."kedi" = {
      ...
      ingress = {
        "6a.kedi.dev" = "http://voyager:8123";
        "actual.kedi.dev" = "http://voyager:3100";
        "immich.kedi.dev" = "http://endeavour:2283";
        "mealie.kedi.dev" = "http://voyager:9000";
        "open-webui.kedi.dev" = "http://endeavour:8090";
        "radicale.kedi.dev" = "http://voyager:5232";
        "seafile.kedi.dev" = "http://endeavour:4000";
        "vault.kedi.dev" = "http://voyager:8222";
      };
      credentialsFile =
