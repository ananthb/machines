...

{
  ...
  homebrew.casks = [ "wireshark" "jellyfin" "kopiaui" "utm" ];
  homebrew.masApps = { };
  ...
  launchd = {
    user = {
      agents = {
        ...
        tsnet-serve-tv = {
          command =
            "/Users/ananth/Downloads/tsnet-serve -funnel -hostname tv -state-dir /Users/ananth/Downloads/state -backend localhost:8096";
          serviceConfig = {
            KeepAlive = true;
            RunAtLoad = true;
          };
